...
def test_drhmc_leapfrog_num_evals(num_proposals) -> None:
    ...
    drhmc = DrGhmcDiag(model, steps=10, stepsize=0.25, num_proposals=num_proposals)
...
def test_drhmc_std_normal_adaptive(adaptivity_factor) -> None:
    ...
    drhmc = DrGhmcDiag(model, steps=steps, stepsize=stepsize, init=init)
...
def test_drhmc_diag_repr() -> None:
    ...
    drhmc_1 = DrGhmcDiag(model, steps=10, stepsize=0.25, init=init, seed=123)
    drhmc_2 = DrGhmcDiag(model, steps=10, stepsize=0.25, init=init, seed=123)
...
def test_drhmc_binom_adaptive(adaptivity_factor) -> None:
    ...
    drhmc = DrGhmcDiag(model, stepsize=stepsize, steps=steps, init=init)
